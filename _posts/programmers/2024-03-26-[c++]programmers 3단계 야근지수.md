---
layout: post
title: programmers 3단계 야근지수
categories : programmers 3단계
tag : [programmers,priority_queue]
---
...
1. 일단 works에 있는 모든 값을 더한 값보다 n이 더 크거나 같다면 0리턴
2. 우선순위 큐에 푸시해줌
3. n이 0이 될때까지 que의 top에 있는 값들을 -- 해준다. (que 오름차순으로 자동정렬 되기 때문)
4. que에 있는 값들 pow로 제곱해주고 answer에 더해줌.
