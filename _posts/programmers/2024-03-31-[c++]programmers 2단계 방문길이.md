---
layout: post
title: programmers 2단계 방문길이
categories : programmers 2단계
tag : [programmers,set,pair]
---
...
소요시간 05:52 ~ 06:30 (48분)   


set을 사용하여 중복을 제거하였다.

1. set구조에 pair를 사용하여<현재위치,다음 위치>를 저장한다.
2. 만약 <갈 위치, 현재위치>가 있다면 걸어본 길이므로, 없다면 set에 insert해준다.
ex) 0,0 -> 0,1 을 갔을때 0,1 -> 0,0 걸어본 길이므로   
