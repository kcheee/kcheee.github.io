---
layout: post
title: programmers 2단계 게임 맵 최단거리
categories : programmers 2단계
tag : [programmers,bfs,queue]
---
...
**풀이**   
1. 방문여부, 회수를 저장할 벡터를 선언, pair를 사용한 queue도 선언해준다.
2. 동서남북을 탐색하기 위한 dr,dc 배열
3. 벽과 방문여부에 따른 회수증가하는 bfs 코드
